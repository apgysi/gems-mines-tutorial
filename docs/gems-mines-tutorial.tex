...
In this chapter we will learn how to build a pH-activity diagram for the speciation of rare earth elements (REE).

\hypertarget{test}{%
\section{test}\label{test}}

In this mode, we can simulate a ``wave'' of a fluid that will pass through a series of 100 rock nodes once per step (i.e., a wave consists of ca. 100 substeps) with an initial fluid/rock ratio of 10.

A schematic of the sequential reactors chain is shown in Figure \ref{fig:fig-1e}.
